Rails.application.routes.draw do
  ...
  get 'home_pages/student_login', to: 'sessions_student#new'
  post 'home_pages/student_login', to: 'sessions_student#create'
  delete 'home_pages/student_logout', to: 'sessions_student#destroy'
