...
class EvaluatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluate" do
    assert_difference('Evaluate.count') do
      post evaluates_url, params: { evaluate: { comments: @evaluate.comments, rating: @evaluate.rating } }
    end
  ...
  test "should update evaluate" do
    patch evaluate_url(@evaluate), params: { evaluate: { comments: @evaluate.comments, rating: @evaluate.rating } }
