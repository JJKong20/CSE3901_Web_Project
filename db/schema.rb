...
ActiveRecord::Schema.define(version: 2022_04_23_065246) do
  ...
  add_foreign_key "evaluates", "students", column: "recipient_id"
  add_foreign_key "evaluates", "students", column: "sender_id"
